...
namespace global_motion_planner
{
  ...
  public:
     ...
     */
    GA(int nx, int ny, double resolution, double origin_x, double origin_y, int n_genets,int n_inherited, int chromLength , double p_select, double p_crs, double p_mut, double obs_factor,int max_speed,int initposmode ,bool pub_genets,int max_iter);
    ~GA();
